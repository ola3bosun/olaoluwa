...
export default function ContactPage() {
  ...
  // Lock the previous image just behind the new one so the screen doesn't flash empty
    if (prevImg) {
      gsap.set(prevImg, { zIndex: 1, opacity: 1, scale: 1 })
    }

    // lifts the current image to the front, start it small (0.3), and expand it outward while fading in
